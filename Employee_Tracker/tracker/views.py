...
import hashlib
from .models import employee_details,mark_attendance_report,GeofencedArea
...
def Upload_employee_details(request):
    ...
    try:
        df_csv = pd.read_csv(BytesIO(uploaded_file.read()))
        ...
        return Response('error in file upload')
